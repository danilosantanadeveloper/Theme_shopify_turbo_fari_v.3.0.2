    ...
    if (this.autorotate) {
      $(document).scroll(
        $.debounce(
          250,
          function() {
            var $arrowsMobile_top = 0;
            if (this.$arrowsMobile.length) {
              $arrowsMobile_top = this.$arrowsMobile.offset().top;
            }
            if (
              $arrowsMobile_top +
  ...
  BOLD.common.eventEmitter.emit('BOLD_COMMON_cart_loaded');
    ...
    _updatePrice: function(evt) {
      ...
      if (variant.compare_at_price > variant.price) {
        ...
        // Regular price
        $regularPrice.html(
          theme.Currency.formatMoney(variant.price, theme.moneyFormat).replace("€", "")
        );
      }
...
$(document).ready(function() {
  ...
  $('.template-product').find('.selector-wrapper').each(function(){
    $(this).find('.varia-notr').find('.option-item').first().find('.color-swatch').click();
  });


  $('.link_social_icon').mouseenter(function(){
    $(this).find('.c_social_icon').css('display', 'none');
    $(this).find('.d_social_icon').css('display', 'block');
  });
  $('.link_social_icon').mouseleave(function(){
    $(this).find('.d_social_icon').css('display', 'none');
    $(this).find('.c_social_icon').css('display', 'block');
  });
  
  $('.go-add-to-cart').click(function(){
  ...
  $('.color-swatch').click(function(){
    var closest_p = $(this).closest('.varia-notr');
    var option_title = $(this).attr('title');
    closest_p.find('.option-item').each(function(){
      var ele = $(this).find('.color-swatch');
      var compare_option_title = ele.attr('title');
      if(option_title == compare_option_title) {
        ele.addClass('active');
      }
      else {
    ...
    if ($(this).closest('.selector-wrapper').hasClass('type--smaak')) {
      $('.bundle_container').find('.product-cell').each(function(){
        $(this).find('.option-item').each(function(){
          var ele = $(this).find('.bundle-color-swatch');
          var compare_option_title = ele.attr('title');
          if(option_title == compare_option_title) {
            ele.addClass('active');
            if (ele.hasClass('Mint')) {
              $(this).closest('.product-cell').find('.lazylo-colam').find('.slick-dots').find('li').each(function( index ){
                if (index == 0 ) {
                  $(this).click();
                }
                else {
              ...
              var target = $(this).closest('.product-cell').find('.bundle-form__variants');
              target.val(target.find('option:first-child').val());
            }
            else {
              $(this).closest('.product-cell').find('.lazylo-colam').find('.slick-dots').find('li').each(function( index ){
                if (index == 1 ) {
              ...
              var target = $(this).closest('.product-cell').find('.bundle-form__variants');
              target.val(target.find('option:last-child').val());
            }
          }
          else {
            ele.removeClass('active');
  ...
  $('.grid-item-swatch').click(function(){
    var big_ele = $(this).closest('.product-card');
    var p_ele = $(this).closest('.varia-notr');
    p_ele.find('.option-item').each(function(){
      $(this).find('.color-swatch').removeClass('active');
    });
    var option_title = $(this).data('title').replace(/\s/g, '');
    if (option_title == 'aardbei') {
      big_ele.find('.slick-dots').find("li").each(function(index){
        if( index == 1 ) {
          $(this).find('button').click();
        }
      });
      big_ele.find('.image-cell').find('.s--1').css('display','none');
      big_ele.find('.image-cell').find('.s--2').css('display','block');
    }
    else {
      big_ele.find('.slick-dots').find("li").each(function(index){
        if( index == 0 ) {
      ...
      big_ele.find('.image-cell').find('.s--2').css('display','none');
      big_ele.find('.image-cell').find('.s--1').css('display','block');
    }
    var v_select_ele = $(this).closest('.badg-cx').find('.product-form__variants');
    var v_id = v_select_ele.val();
    var v_available = true;
    v_select_ele.find('option').each(function(){
     var option = $(this).text().replace(/\s/g, '');
    ...
    v_select_ele.val(v_id);
    if(!v_available) {
      big_ele.find('.go_to_product').html('Binnenkort verkrijgbaar').attr('disabled',true);
      big_ele.find('.go-add-to-cart').html('Binnenkort verkrijgbaar').attr('disabled',true);
    }
    else {
      big_ele.find('.go_to_product').html('KOPEN').attr('disabled',false);
      big_ele.find('.go-add-to-cart').html('KOPEN').attr('disabled',false);
    }
    $(this).addClass('active');
  });
  $('.go_to_product').click(function(){
    if (!$(this).hasClass('.sold-out')) {
      var variant_id = $(this).closest('.product-card').find('.product-form__variants').val();
...
theme.init = function() {
  ...
  var btn_6 = document.getElementById("anim_6_btn");
  var btn_7 = document.getElementById("Group_172");
  var anim1_btn = document.getElementById("anim1_btn");
  var anim2_btn = document.getElementById("anim2_btn");
  var anim3_button = document.getElementById("anim3_button");
  ...
  if(btn_6 || btn_7){
      ...
      btn_6.addEventListener("click",function(){
          window.location.href = "/products/fairytabs-starter-kit";
      })
      ...
      btn_7.style.cursor="pointer";
      
    
    
      var Rectangle_1470 = document.getElementById("Rectangle_1470");
      var ga_naar_de_shop = document.getElementById("ga_naar_de_shop");

      Rectangle_1470.addEventListener("mouseover",function(){

          Rectangle_1470.style.fill="#fff";
          Rectangle_1470.style.stroke="#005670";
          ga_naar_de_shop.getElementsByTagName("text")[0].style.fill="#005670";

      })
      
      Rectangle_1470.addEventListener("mouseout",function(){

          Rectangle_1470.style.fill="#005670";
          Rectangle_1470.style.stroke="#005670";
          ga_naar_de_shop.getElementsByTagName("text")[0].style.fill="#fff";
          
      })
      
      ga_naar_de_shop.addEventListener("mouseover",function(){
      ...
      ga_naar_de_shop.addEventListener("mouseout",function(){
  ...
  if(anim1_btn){
      ...
      anim1_btn.style.cursor="pointer";

      anim1_btn.addEventListener("click",function(){
          window.location.href = "/pages/over-ons";
      })


      var Rectangle_1090 = document.getElementById("Rectangle_1090");
      var over = document.getElementById("over");



      Rectangle_1090.addEventListener("mouseover",function(){

          Rectangle_1090.style.fill="#fff";
          Rectangle_1090.style.stroke="#005670";
          over.getElementsByTagName("text")[0].style.fill="#005670";

      })
      
      Rectangle_1090.addEventListener("mouseout",function(){

          Rectangle_1090.style.fill="#005670";
          Rectangle_1090.style.stroke="#005670";
          over.getElementsByTagName("text")[0].style.fill="#fff";
  ...
  if(anim3_button){
    ...
    anim3_button.style.cursor="pointer";

      anim3_button.addEventListener("click",function(){
          window.location.href = "/pages/partners";
      })

          
      var Rectangle_1470 = document.getElementById("Rectangle_1470");
      var partners_van_Fairytabs = document.getElementById("partners_van_Fairytabs");
      ...
      Rectangle_1470.addEventListener("mouseover",function(){
          ...
          Rectangle_1470.style.fill="#fff";
          Rectangle_1470.style.stroke="#005670";
          partners_van_Fairytabs.getElementsByTagName("text")[0].style.fill="#005670";
      ...
      Rectangle_1470.addEventListener("mouseout",function(){
          ...
          Rectangle_1470.style.fill="#005670";
          Rectangle_1470.style.stroke="#005670";
          partners_van_Fairytabs.getElementsByTagName("text")[0].style.fill="#fff";
          
      })
      
      partners_van_Fairytabs.addEventListener("mouseover",function(){
    ...
    partners_van_Fairytabs.addEventListener("mouseout",function(){
  ...
  if(anim2_btn){
    ...
    anim2_btn.style.cursor="pointer";

      anim2_btn.addEventListener("click",function(){
          window.location.href = "/pages/partners";
      })

          
      var Rectangle_1470 = anim2_btn.getElementsByTagName("rect")[0];
      var partners_van_Fairytabs = anim2_btn.getElementsByTagName("text")[0]
      ...
      Rectangle_1470.addEventListener("mouseover",function(){
          ...
          Rectangle_1470.style.fill="#fff";
          Rectangle_1470.style.stroke="#005670";
          partners_van_Fairytabs.style.fill="#005670";
      ...
      Rectangle_1470.addEventListener("mouseout",function(){
          ...
          Rectangle_1470.style.fill="#005670";
          Rectangle_1470.style.stroke="#005670";
          partners_van_Fairytabs.style.fill="#fff";
    ...
    Array.from(items).forEach((item) => {
      ...
      title.addEventListener("click", (e) => {
        ...
        if (parent.classList.contains("open")) {
          textbox.style.maxHeight = textbox.scrollHeight + 200 + "px";
        } else {
  ...
  $(document).ready(function(){
    $('.lazylo-colam').slick({
      ...
      $('.template-product').find('.type--smaak').find('.color-swatch').each(function(){
        $(this).click(function(){
          if ($(this).hasClass('Mint')) {
            $(this).closest('.image-description-c').find('.product-main-image-wrap').find('.slick-dots').find('li').each(function( index ){
              if (index == 0 ) {
                $(this).click();
              }
              else {
